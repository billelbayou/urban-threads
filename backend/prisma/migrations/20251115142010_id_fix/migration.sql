/*
  ...
  - The primary key for the `ProductStats` table will be changed. If it partially fails, the table could be left without primary key constraint.
...
-- AlterTable
ALTER TABLE "ProductStats" DROP CONSTRAINT "ProductStats_pkey",
ALTER COLUMN "id" DROP DEFAULT,
ALTER COLUMN "id" SET DATA TYPE TEXT,
ALTER COLUMN "productId" SET DATA TYPE TEXT,
ADD CONSTRAINT "ProductStats_pkey" PRIMARY KEY ("id");
DROP SEQUENCE "ProductStats_id_seq";
